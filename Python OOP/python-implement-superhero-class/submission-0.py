...
print(superhero_one.name)
print(superhero_one.power)
print(superhero_one.health)
print(superhero_two.name)
print(superhero_two.power)
print(superhero_two.health)